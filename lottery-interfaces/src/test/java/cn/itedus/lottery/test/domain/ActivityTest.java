...
public class ActivityTest {
    ...
    public void test_alterState() {
        ...
        logger.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityState.ARRAIGNMENT)));
        logger.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityState.PASS)));
        logger.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityState.REFUSE)));
        logger.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityState.CLOSE)));
        logger.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityState.OPEN)));
    ...
    public void test_activityPartake(){
        PartakeReq partakeReq = new PartakeReq("Uhdgkw766120d", 100001L ,new Date());
