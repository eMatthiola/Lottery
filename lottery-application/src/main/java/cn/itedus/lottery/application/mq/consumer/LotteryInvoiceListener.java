...
public class LotteryInvoiceListener {
    ...
    @KafkaListener(topics = "lottery_invoice1",groupId = "lottery")
    public void onMessage(ConsumerRecord<?, ?> record, Acknowledgment ack, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic){
        ...
        // 2. 处理 MQ 消息
        try {
            // 1. JSON to Object（或者你也可以重写Serializer<T>）
...
//            Assert.isTrue(Constants.AwardState.SUCCESS.equals(distributionRes.getCode()), distributionRes.getInfo());
