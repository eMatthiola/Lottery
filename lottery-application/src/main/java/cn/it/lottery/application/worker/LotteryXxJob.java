package cn.it.lottery.application.worker;

import cn.it.lottery.application.mq.producer.KafkaProducer;
...
/**
 * @ClassName LotteryXxJob
 * @Description 抽奖业务，任务配置
 * @Author Matthiola
 * @Date 2023/10/24 11:58
 */
@Component
public class LotteryXxJob {

    private Logger logger = LoggerFactory.getLogger(LotteryXxJob.class);
    @Resource
    ...
    private void lotteryOrderMQStateJobHandler() throws Exception{
        ...
        for (String param : params) {
            ...
            for (int i = 0; i < tbCount; i++) {
                ...
                // 扫描库表数据,get data which needed to compensate
