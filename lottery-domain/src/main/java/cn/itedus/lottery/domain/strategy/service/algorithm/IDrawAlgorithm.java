...
public interface IDrawAlgorithm {
     ...
     * @return                  中奖结果
     */
    String randomRun(Long strategyId, List<String> excludeAwardIds);
     ...
     * 将数据库的数据写入到 Map
     * @param strategyId    策略ID
     * @param awardRateInfoList    awardId awardRate
     */
    void initAward(Long strategyId, List<AwardRateInfo> awardRateInfoList);
}
